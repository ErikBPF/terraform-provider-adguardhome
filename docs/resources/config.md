...
page_title: "adguardhome_config Resource - adguardhome"
subcategory: ""
description: |-
  
---

# adguardhome_config (Resource)
...
- `private_key` (String, Sensitive) The private key. Supply either a path to a file or a base64 encoded string of the private key in PEM format
